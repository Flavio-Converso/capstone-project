        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GamesOrdered = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pegis", x => x.PegiId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameKeyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KeyNum = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    GameId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameKeys", x => x.GameKeyId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameRestriction", x => new { x.GamesGameId, x.RestrictionsRestrictionId });
                    table.ForeignKey(
                        name: "FK_GameRestriction_Games_GamesGameId",
                        column: x => x.GamesGameId,
                        principalTable: "Games",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameRestriction_Restrictions_RestrictionsRestrictionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameRestriction_RestrictionsRestrictionId",
                table: "GameRestriction",
